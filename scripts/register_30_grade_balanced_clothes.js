...
// 정확히 30종 (저학년 10종 / 중학년 10종 / 고학년 10종) 데이터셋
const THIRTY_CLOTHES_DATASET = [
  // ==========================================
  // 🎒 1~2학년 (저학년용 / 10종 / Size 110 ~ 120)
  // ==========================================
  {
  ...
  },
  {
    ...
    name: '키즈 [1~2학년용] 클래식 네이비 플리츠 스커트',
    category: '하의',
    color: '네이비',
    style: '교복',
  ...
  },
  {
    ...
    name: '초등 키즈 [1~2학년용] 무독성 스판 데님 바지',
    category: '하의',
    color: '블루',
    style: '일상복',
  ...
  },
  {
    prefix: 'kids_denim_pants',
    filename: 'kids_denim_pants.png',
    name: '초등 고학년 [5~6학년용] 와이드 핏 데님 바지',
    category: '하의',
    color: '블루',
    style: '일상복',
...
async function run() {
  ...
  console.log("🚀 Registering Exactly 30 Items Dataset (10 for 1-2th, 10 for 3-4th, 10 for 5-6th grade)...");

  let count = 0;
  for (const item of THIRTY_CLOTHES_DATASET) {
  ...
  console.log(`\n🎉 Total 30 Items Dataset Registration Complete (${count} items)!`);
}
